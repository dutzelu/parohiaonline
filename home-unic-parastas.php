...
while($data = $result->fetch_assoc()) {
    ...
    echo '<p class="inapoi"><a href="home-parastas.php"><i class="fas fa-chevron-circle-left"></i> Înapoi</a></p>';
    ...
    echo "<p>";
        ...
        <a style="width:30%" href="sterge.php?eveniment=programari_parastas&data=<?php echo date("Y-m-d", strtotime($data_si_ora)); ?>&stergeid=<?php echo $id_programare; ?>" class="sterge btn btn-danger" onclick="return confirm('Sunteți sigur că vreți să ștergeți această programare?');" role="button">Șterge</a>
...
if (empty($succes)) {
    ...
    echo '<form method="POST" action="raspunde-client.php?id=' . $id_programare . '&eveniment=parastas">' .
