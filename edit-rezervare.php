...
<div class="mare">
 ...
 echo '<h5>Modifică rezervarea din <br />'  . date("d.m.Y", strtotime($data_si_ora)) . ' - ' . $eveniment . ' - ora: ' . date("H:i", strtotime($data_si_ora)) . ' - '  . $nume_mama . ' ' . $prenume_mama . '</h5>';

    echo  '<hr />';
 
 ?>

<form action="update-edit-rezervare.php?id=<?php echo $id_programare?>" method="post" enctype = "multipart/form-data">
...
<div class="row mb-1">
    <label class="col-sm-4 col-form-label">Carte identitate mamă *</label>
         <div class="col-sm-8">
                <input type="file" name="mama_ci" class="col-sm-8 form-control" >
          </div>
</div>
...
<div class="row mb-1">
    ...
    <div class="col-sm-8">
     <input type="file" name="certificat_nastere_copil" class="col-sm-8 form-control" >
    </div>
</div>
