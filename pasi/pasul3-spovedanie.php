...
<div class="container-fluid">
    ...
    <div class="col-xl-9 ultimele-programari">
     ...
     <form  method="POST" action="pasul4-spovedanie.php<?php echo '?month=' . $month . '&year=' .  $year . '&pentru=' .  $pentru . '&zi=' . $zi . '&ora=' . $ora;?> " enctype = "multipart/form-data">
     ...
     <div class="row">
         <div class="col-sm">
             <p><input type="text" name="nume" class="form-control" placeholder="Nume" ></p>
        </div>
        <div class="col-sm">
            <p><input type="text" name="prenume" class="form-control" placeholder="Prenume"></p>
        </div>
    </div>
