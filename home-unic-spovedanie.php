...
while($data = $result->fetch_assoc()) {
    ...
    echo "<p class='butoane'>";
        ...
        <a href="sterge.php?eveniment=programari_spovedanie&stergeid=<?php echo $id_programare; ?>" class="sterge" onclick="return confirm('Sunteți sigur că vreți să ștergeți această programare?');">
          <i class="rosu fas fa-trash-alt"></i> Anulează spovedania</a>
