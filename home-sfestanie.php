...
<title>Programări Sfeștanii</title>
</head>
...
<div class="container-fluid">
    ...
    <div class="row wrapper">
        ...
        <div class="row mt-3 ultimele-programari">
              <p class="fw-bold">Programări SFEȘTANII</p>
             ...
             ?>
                 <div class="table-responsive">
                        ...
                        <tbody >
                          ...
                          if (isset($_GET['page_no']) && $_GET['page_no']!="") {
                            ...
                            FROM (
                                ...
                                Select id, 'sfestanie' as Programare, concat(nume, ' ', prenume) as Nume , DATE(data_si_ora) as Data, DATE_FORMAT(data_si_ora,'%H:%i') as Ora, status FROM programari_sfestanie 
                                WHERE user_id = ?
                            ...
                            <tr class='clickable-row' data-href="<?php echo "home-unic-sfestanie.php?id=" . $row['id'];
                            ?>">
                    ...
                    <?php 
                    $link_paginatie = 'home-sfestanie.php?'; 
