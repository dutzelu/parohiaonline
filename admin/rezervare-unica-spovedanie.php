...
while($data = $result->fetch_assoc()) {
  ...
  echo "<p>";
              ...
              <a href="actiuni.php?eveniment=programari_spovedanie&stergeid=<?php echo $id_programare; ?>" class="sterge" onclick="return confirm('Sunteți sigur că vreți să ștergeți această programare?');">
