...
$query = 'SELECT * FROM programari_spovedanie WHERE id = ? ORDER BY id DESC';
$stmt = $conn->prepare($query);
...
while($data = $result->fetch_assoc()) {
  ...
  echo "<p>";
              ...
              <a href="sterge-camp.php?eveniment=programari_spovedanie&stergeid=<?php echo $id_programare; ?>" class="sterge" onclick="return confirm('Sunteți sigur că vreți să ștergeți această programare?');">
