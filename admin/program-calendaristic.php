    ...
    <div class="row wrapper">
        ...
        <div class="col-lg-9 p-4 zona-principala">
            ...
            <ul>
                ...
                <li class="badge bg-info">stabilește oricâte zile vrei (7, 14, 30, 60, 90, etc.)</li>
                <li class="badge bg-danger">nu se repetă</li>
            </ul>
                ...
                <div id="readroot" style="display: none">
                    ...
                    <div class="input-group mb-2">
                        <span class="input-group-text">Alege o zi din calendar</span>
                            <input type="date" name="ziua_saptamanii" class="form-control">
                    </div>
                    ...
                    <input id="ora_final" type="text" name="text_optional" placeholder="precizări despre slujbă" class="form-control" value="">
