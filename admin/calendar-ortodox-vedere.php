...
//---------------------------------------------------
            ...
            if ($nrSaptPanaLaTriod == 3) {
                ...
                echo $data_duminicii . ' - ' . "Duminica a 17-a după Rusalii (a Canaanencei)";
            ...
            if ($nrSaptPanaLaTriod == 4) {
                ...
                $data_duminicii = date('d M Y', strtotime($Duminica_dupa_Botezul_Domnului. ' + 14 days'));
                echo $data_duminicii . ' - ' . "Duminica a 31-a după Rusalii (Vindecarea orbului din Ierihon)";
            ...
            if ($nrSaptPanaLaTriod == 5) {
                ...
                $data_duminicii = date('d M Y', strtotime($Duminica_dupa_Botezul_Domnului. ' + 28 days'));
                echo $data_duminicii . ' - ' . "Duminica a 16-a după Rusalii (Pilda talanților)";
            ...
            if ($nrSaptPanaLaTriod == 6) {
                ...
                $data_duminicii = date('d M Y', strtotime($Duminica_dupa_Botezul_Domnului. ' + 28 days'));
                echo $data_duminicii . ' - ' . "Duminica a 15-a după Rusalii (Porunca cea mare din Lege)";
            ...
            echo $Inceputul_Postului_Mare . " - <strong>Începutul Postului Sfintelor Paști. Canonul cel Mare. Zi aliturgică.</strong>";
            ...
            echo  $Duminica_Rusalii_18 . " - Duminica a 18-a după Rusalii (Pescuirea minunată)";    
            ...
            echo $Duminica_Rusalii_19 . " - Duminica a 19-a după Rusalii (Predica de pe munte - iubirea vrăjmașilor)";    
            ...
            for ($x=11; $x <= 17; $x++) {
                ...
                if ($ziua_Duminica_Rusalii_21 == 0) {
                    ...
                    echo "<br>";
                    echo $Duminica_Rusalii_21_corecta . " - Duminica a 21-a după Rusalii (a Sf. Părinți de la Sinodul al VII-lea ecumenic)"; 
                }
            }
            ...
            for ($x=30; $x <= 31; $x++) {
                ...
                if ($ziua_Duminica_Rusalii_22 == 0) {
                    ...
                    $Duminica_Rusalii_22_corecta = date('d M Y', strtotime($Duminica_Rusalii_22));
                     ...
                     echo "<br>";
                     echo $Duminica_Rusalii_22_corecta . " - Duminica a 22-a după Rusalii (Bogatul nemilostiv și săracul Lazăr)"; 
                }
            ...
            // Aflu toate duminicile rămase libere în octombrie 
                ...
                echo "<br>";
                aflaDuminici ($an_ales, 10);

                foreach ($duminici_in_luna as $dum) {


                $duminica = date('d M Y', strtotime($dum . '-10-' . $an_ales)); 
            ...
            aflaDuminici ($an_ales, 11);
            end($duminici_in_luna);

            $ultima_duminica_din_nov = $an_ales . '-11-' . end($duminici_in_luna);
            ...
            echo $Duminica_Rusalii_25 . " - Duminica a 25-a după Rusalii (Pilda Samarineanului milostiv)";
            ...
            echo $Duminica_Rusalii_26 . " - Duminica a 26-a după Rusalii (Pilda bogatului căruia i-a rodit țarina)";
            ...
            echo $Duminica_Rusalii_27 . " - Duminica a 27-a după Rusalii (Pilda bogatului căruia i-a rodit țarina)";
            ...
            // Aflu toate duminicile rămase libere în noiembrie 
                ...
                foreach ($duminici_in_luna as $dum) {
                    ...
                    $duminica = date('d M Y', strtotime($dum .  '-11-' . $an_ales)); 
                    if ( !array_key_exists($duminica, $calendarMobil) ) {
                        $duminici_libere_oct_nov[]= $duminica;
                    }
                } 
            ...
            echo "<br>";
            // echo '<pre>'; print_r($duminici_libere_oct_nov); echo '</pre>';
            // echo "<br>";
            ...
            if (array_key_last($duminici_libere_oct_nov) == 2) {
                ...
                echo $Duminica_Rusalii_20 . " - Duminica a 20-a după Rusalii (Învierea fiului văduvei din Nain)";
                ...
                echo $Duminica_Rusalii_23 . " - Duminica a 23-a după Rusalii (Vindecarea demonizatului din ținutul Gherghesenilor)"; 
                ...
                echo $Duminica_Rusalii_24 . " - Duminica a 24-a după Rusalii (Învierea fiicei lui Iair)";  
